...
[@bs.new] external uint8arrayAsIntArray: Reasongl.arrayBufferT => array(int) = "Uint8Array";
        ...
        | BinaryAsset(fileName) =>
            ...
            Reasongl.onreadystatechange(req, () => {
              ...
              /*results(remoteAsset) = new AjaxBinaryResult(new BinaryBuffer(new Uint8Array(arrayBuffer)))*/
                    results[i] = AjaxBinaryResult(uint8arrayAsIntArray(Reasongl.getResponse(req)));

module Point = {
    ...
    let normal = (p1, p2, p3) => {
        let v1 = Data.Vec3.make(
            p2.x -. p1.x,
            p2.y -. p1.y,
            p2.z -. p1.z
        );
        let v2 = Data.Vec3.make(
            p3.x -. p1.x,
            p3.y -. p1.y,
            p3.z -. p1.z
        );
...
module AreaBetweenQuads = {
    ...
    let createVertexData = (self) => {
        ...
        [|
            /* Front face */
            q1.bl.x, q1.bl.y, q1.bl.z, fNorm[0], fNorm[1], fNorm[2],
            q1.br.x, q1.br.y, q1.br.z, fNorm[0], fNorm[1], fNorm[2],
            q1.tr.x, q1.tr.y, q1.tr.z, fNorm[0], fNorm[1], fNorm[2],
            q1.tl.x, q1.tl.y, q1.tl.z, fNorm[0], fNorm[1], fNorm[2],

            /* Right face, right side of q1 and q2 */
            q1.br.x, q1.br.y, q1.br.z, rNorm[0], rNorm[1], rNorm[2],
            q2.br.x, q2.br.y, q2.br.z, rNorm[0], rNorm[1], rNorm[2],
            q2.tr.x, q2.tr.y, q2.tr.z, rNorm[0], rNorm[1], rNorm[2],
            q1.tr.x, q1.tr.y, q1.tr.z, rNorm[0], rNorm[1], rNorm[2],

            /* Bottom face */
            q2.bl.x, q2.bl.y, q2.bl.z, bNorm[0], bNorm[1], bNorm[2],
            q2.br.x, q2.br.y, q2.br.z, bNorm[0], bNorm[1], bNorm[2],
            q1.br.x, q1.br.y, q1.br.z, bNorm[0], bNorm[1], bNorm[2],
            q1.bl.x, q1.bl.y, q1.bl.z, bNorm[0], bNorm[1], bNorm[2],

            /* Left face, left side of q2 and q1 */
            q2.bl.x, q2.bl.y, q2.bl.z, lNorm[0], lNorm[1], lNorm[2],
            q1.bl.x, q1.bl.y, q1.bl.z, lNorm[0], lNorm[1], lNorm[2],
            q1.tl.x, q1.tl.y, q1.tl.z, lNorm[0], lNorm[1], lNorm[2],
            q2.tl.x, q2.tl.y, q2.tl.z, lNorm[0], lNorm[1], lNorm[2],

            /* Top face */
            q2.tr.x, q2.tr.y, q2.tr.z, tNorm[0], tNorm[1], tNorm[2],
            q2.tl.x, q2.tl.y, q2.tl.z, tNorm[0], tNorm[1], tNorm[2],
            q1.tl.x, q1.tl.y, q1.tl.z, tNorm[0], tNorm[1], tNorm[2],
            q1.tr.x, q1.tr.y, q1.tr.z, tNorm[0], tNorm[1], tNorm[2],

            /* Back face */
            q2.bl.x, q2.bl.y, q2.bl.z, bkNorm[0], bkNorm[1], bkNorm[2],
            q2.tl.x, q2.tl.y, q2.tl.z, bkNorm[0], bkNorm[1], bkNorm[2],
            q2.tr.x, q2.tr.y, q2.tr.z, bkNorm[0], bkNorm[1], bkNorm[2],
            q2.br.x, q2.br.y, q2.br.z, bkNorm[0], bkNorm[1], bkNorm[2]
        |]
    };
